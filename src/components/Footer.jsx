...
const Footer = () => {
    return (
        <div className="container my-5">
            <div className="row">
                <div className="col">
                    <a href={"https://www.instagram.com/adnpalermo/"} className="me-3"><img src={instagram} alt={"Instagram"} width={"24"} /></a>
                    <a href={"https://www.youtube.com/@adnnutrition7773"}><img src={youtube} alt={"YouTube"} width={"24"} /></a>
                </div>
            ...
            <div className="row">
                ...
                <div className="col-md-4 text-end text-secondary">
                    <p><img src={logo} alt={"AdnNutrition"} width={"40"} /> © ADNNUTRITION 2023</p>
                </div>
            </div>
        </div>
